...
const words = [
  {
    word: "Table",
    translate: "Стол",
    example: "Take a seat at the table",
  },

  {
    word: "Snow",
    translate: "Снег",
    example: "The first snow has fallen outside",
  },

  {
    word: "Fairy tale",
    translate: "Сказка",
    example: "Children love to read fairy tales before bed",
  },

  {
    word: "Gift",
    translate: "Подарок",
    example: "Everyone loves gifts",
  },

  {
    word: "Tea",
    translate: "Чай",
    example: "He drinks hot tea",
  }
];
